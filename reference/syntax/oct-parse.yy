////////////////////////////////////////////////////////////////////////
//
// Copyright (C) 1993-2021 The Xyz Project Developers
//
// See the file COPYRIGHT.md in the top-level directory of this
// distribution or <https://xyz.org/copyright/>.
//
// This file is part of Xyz.
//
// Xyz is free software: you can redistribute it and/or modify it
// under the terms of the GNU General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// Xyz is distributed in the hope that it will be useful, but
// WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU General Public License
// along with Xyz; see the file COPYING.  If not, see
...
extern int xyz_lex (YYSTYPE *, void *);

// Forward declarations for some functions defined at the bottom of
// the file.

static void yyerror (xyz::base_parser& parser, const char *s);

#define lexer (parser.get_lexer ())
#define scanner lexer.m_scanner

// Previous versions of Xyz used Bison's YYUSE macro to avoid
...
// interface but the Xyz parser and lexer are NOT properly
...
%define api.prefix {xyz_}
%define api.push-pull both
%parse-param { xyz::base_parser& parser }
...
%union
{
  ...
  xyz::comment_list *comment_type;

  // Types for the nonterminals we generate.
  char punct_type;
  xyz::tree *tree_type;
  xyz::tree_matrix *tree_matrix_type;
  xyz::tree_cell *tree_cell_type;
  xyz::tree_expression *tree_expression_type;
  xyz::tree_constant *tree_constant_type;
  xyz::tree_fcn_handle *tree_fcn_handle_type;
  xyz::tree_superclass_ref *tree_superclass_ref_type;
  xyz::tree_metaclass_query *tree_metaclass_query_type;
  xyz::tree_function_def *tree_function_def_type;
  xyz::tree_anon_fcn_handle *tree_anon_fcn_handle_type;
  xyz::tree_identifier *tree_identifier_type;
  xyz::tree_index_expression *tree_index_expression_type;
  xyz::tree_colon_expression *tree_colon_expression_type;
  xyz::tree_argument_list *tree_argument_list_type;
  xyz::tree_parameter_list *tree_parameter_list_type;
  xyz::tree_command *tree_command_type;
  xyz::tree_if_command *tree_if_command_type;
  xyz::tree_if_clause *tree_if_clause_type;
  xyz::tree_if_command_list *tree_if_command_list_type;
  xyz::tree_switch_command *tree_switch_command_type;
  xyz::tree_switch_case *tree_switch_case_type;
  xyz::tree_switch_case_list *tree_switch_case_list_type;
  xyz::tree_decl_elt *tree_decl_elt_type;
  xyz::tree_decl_init_list *tree_decl_init_list_type;
  xyz::tree_decl_command *tree_decl_command_type;
  xyz::tree_statement *tree_statement_type;
  xyz::tree_statement_list *tree_statement_list_type;
  xyz::tree_arguments_block *tree_arguments_block_type;
  xyz::tree_args_block_attribute_list *tree_args_block_attribute_list_type;
  xyz::tree_args_block_validation_list *tree_args_block_validation_list_type;
  xyz::tree_arg_size_spec *tree_arg_size_spec_type;
  xyz::tree_arg_validation *tree_arg_validation_type;
  xyz::tree_arg_validation_fcns *tree_arg_validation_fcns_type;
  xyz_user_function *xyz_user_function_type;

  xyz::tree_classdef *tree_classdef_type;
  xyz::tree_classdef_attribute* tree_classdef_attribute_type;
  xyz::tree_classdef_attribute_list* tree_classdef_attribute_list_type;
  xyz::tree_classdef_superclass* tree_classdef_superclass_type;
  xyz::tree_classdef_superclass_list* tree_classdef_superclass_list_type;
  xyz::tree_classdef_body* tree_classdef_body_type;
  xyz::tree_classdef_property* tree_classdef_property_type;
  xyz::tree_classdef_property_list* tree_classdef_property_list_type;
  xyz::tree_classdef_properties_block* tree_classdef_properties_block_type;
  xyz::tree_classdef_methods_list* tree_classdef_methods_list_type;
  xyz::tree_classdef_methods_block* tree_classdef_methods_block_type;
  xyz::tree_classdef_event* tree_classdef_event_type;
  xyz::tree_classdef_events_list* tree_classdef_events_list_type;
  xyz::tree_classdef_events_block* tree_classdef_events_block_type;
  xyz::tree_classdef_enum* tree_classdef_enum_type;
  xyz::tree_classdef_enum_list* tree_classdef_enum_list_type;
  xyz::tree_classdef_enum_block* tree_classdef_enum_block_type;
}
...
%type <xyz_user_function_type> method_decl1
...
%destructor { delete $$; } <xyz_user_function_type>
...
input           : simple_list '\n'
                  {
                    ...
                    $$ = nullptr;
                    std::shared_ptr<xyz::tree_statement_list> tmp_lst ($1);
...
fcn_list1       : function
                  {
                    xyz::tree_statement *stmt = parser.make_statement ($1);
                    $$ = new xyz::tree_statement_list (stmt);
                  }
                | fcn_list1 opt_sep function
                  {
                    xyz::tree_statement *stmt = parser.make_statement ($3);
...
identifier      : NAME
                  {
                    ...
                    xyz::symbol_scope scope
                      = lexer.m_symtab_context.curr_scope ();

                    std::string nm = $1->text ();

                    xyz::symbol_record sr
                      = (scope
                         ? scope.insert (nm) : xyz::symbol_record (nm));


                    $$ = new xyz::tree_identifier (sr, $1->line (),
                                                      $1->column ());
                  }
                ;
                ...
                : SUPERCLASSREF
                  {
                    ...
                    $$ = new xyz::tree_superclass_ref (meth, cls,
                                                          $1->line (),
                                                          $1->column ());
                  }
                ;
...
meta_identifier : METAQUERY
                  {
                    ...
                    $$ = new xyz::tree_metaclass_query (cls, $1->line (),
                                                           $1->column ());
                  }
                ;
...
matrix_rows     : cell_or_matrix_row
                  { $$ = $1 ? new xyz::tree_matrix ($1) : nullptr; }
                | matrix_rows ';' cell_or_matrix_row
                  {
                    XYZ_YYUSE ($2);
                    ...
                    if ($1)
                      ...
                      $$ = $3 ? new xyz::tree_matrix ($3) : nullptr;
                  }
                ;
                ...
                | '@' param_list anon_fcn_begin error
                  {
                    ...
                    $$ = nullptr;
                    parser.bison_error (_("anonymous function bodies must be single expressions"));
                    YYABORT;
                  }
                ;
...
magic_colon     : ':'
                  {
                    ...
                    xyz_value tmp (xyz_value::magic_colon_t);
                    $$ = new xyz::tree_constant (tmp);
                  }
                ;
...
decl_elt        : identifier
                  { $$ = new xyz::tree_decl_elt ($1); }
                | identifier '=' expression
                  {
                    XYZ_YYUSE ($2);

                    $$ = new xyz::tree_decl_elt ($1, $3);
                  }
                ;
...
case_list       : // empty
                  { $$ = new xyz::tree_switch_case_list (); }
                | default_case
                  { $$ = new xyz::tree_switch_case_list ($1); }
                | case_list1
                  { $$ = $1; }
...
spmd_command    : SPMD stash_comment opt_sep opt_list END
                  {
                    ...
                    xyz::comment_list *lc = $2;
                    xyz::comment_list *tc = lexer.get_comment ();
                    ...
                    if (lexer.m_looking_at_function_handle)
                      {
                        ...
                        lexer.m_symtab_context.push (xyz::symbol_scope ("parser:param_lsit_beg"));
...
param_list      : param_list_beg param_list1 param_list_end
                ...
                | param_list_beg error
                  {
                    $$ = nullptr;
                    parser.bison_error (_("invalid parameter list"));
                    YYABORT;
                  }
                ;

param_list1     : // empty
                  { $$ = new xyz::tree_parameter_list (xyz::tree_parameter_list::in); }
                | param_list2
                  {
                    $1->mark_as_formal_parameters ();

                    if (parser.validate_param_list ($1, xyz::tree_parameter_list::in))
                      {
...
param_list2     : param_list_elt
                  { $$ = new xyz::tree_parameter_list (xyz::tree_parameter_list::in, $1); }
                | param_list2 ',' param_list_elt
                  {
                    XYZ_YYUSE ($2);
...
return_list     : '[' ']'
                  {
                    ...
                    $$ = new xyz::tree_parameter_list (xyz::tree_parameter_list::out);
                  }
                | identifier
                  {
                    lexer.m_looking_at_return_list = false;

                    xyz::tree_parameter_list *tmp
                      = new xyz::tree_parameter_list (xyz::tree_parameter_list::out, $1);
                    ...
                    if (parser.validate_param_list (tmp, xyz::tree_parameter_list::out))
                      $$ = tmp;
                    else
                      {
                        delete tmp;
                ...
                | '[' return_list1 ']'
                  {
                    ...
                    if (parser.validate_param_list ($2, xyz::tree_parameter_list::out))
                      $$ = $2;
                    else
                      {
                        delete $2;
...
return_list1    : identifier
                  {
                    $$ = new xyz::tree_parameter_list (xyz::tree_parameter_list::out, new xyz::tree_decl_elt ($1));
                  }
                | return_list1 ',' identifier
                  {
                    XYZ_YYUSE ($2);

                    $1->append (new xyz::tree_decl_elt ($3));
                    $$ = $1;
                  }
                ;
...
push_script_symtab : // empty
                  {
                    ...
                    lexer.m_symtab_context.push (xyz::symbol_scope ("parser:push_script_symtab"));
                  }
                ;
...
file            : begin_file opt_nl opt_list END_OF_INPUT
                  {
                    ...
                    if (lexer.m_reading_fcn_file)
                      ...
                      {
                        xyz::tree_statement *end_of_script
...
function_end    : END
                  {
                    ...
                    if (parser.end_token_ok ($1, xyz::token::function_end))
                      $$ = parser.make_end ("endfunction", false,
                                            $1->beg_pos (), $1->end_pos ());
                    else
                      {
                        parser.end_token_error ($1, xyz::token::function_end);
                        YYABORT;
                      }
                  }
                | END_OF_INPUT
...
//                    {
//                      parser.bison_error (_("function body open at end of script"));
//                      YYABORT;
//                    }

                    if (parser.endfunction_found ())
                      {
                        parser.bison_error (_("inconsistent function endings -- "
                    ...
                    if (! (lexer.m_reading_fcn_file || lexer.m_reading_script_file
                      ...
                      {
                        parser.bison_error (_("function body open at end of input"));
                        YYABORT;
                      }

                    if (lexer.m_reading_classdef_file)
                      {
                        parser.bison_error (_("classdef body open at end of input"));
                        YYABORT;
                      }
...
classdef_beg    : CLASSDEF
                  {
                    if (! lexer.m_reading_classdef_file)
                      {
                        parser.bison_error (_("classdef must appear inside a file containing only a class definition"));
                        YYABORT;
                      }

                    // Create invalid parent scope.
                    lexer.m_symtab_context.push (xyz::symbol_scope ());
...
attr_list1      : attr
                  { $$ = new xyz::tree_classdef_attribute_list ($1); }
                | attr_list1 ',' attr
                  {
                    XYZ_YYUSE ($2);
...
attr            : identifier
                  { $$ = new xyz::tree_classdef_attribute ($1); }
                | identifier '=' expression
                  {
                    XYZ_YYUSE ($2);

                    $$ = new xyz::tree_classdef_attribute ($1, $3);
                  }
                | EXPR_NOT identifier
                  {
                    XYZ_YYUSE ($1);

                    $$ = new xyz::tree_classdef_attribute ($2, false);
                  }
                ;
                ...
                : EXPR_LT superclass
                  {
                    ...
                    $$ = new xyz::tree_classdef_superclass_list ($2);
                  }
...
superclass      : FQ_IDENT
                  { $$ = new xyz::tree_classdef_superclass ($1->text ()); }
                ;
...
property_list1
                : class_property
                  { $$ = new xyz::tree_classdef_property_list ($1); }
                | property_list1 sep class_property
                  {
                    ...
                    xyz::tree_classdef_property *last_elt = $1->back ();

                    if (! last_elt->have_doc_string ())
                      {
                        xyz::comment_list *cl = $3->comments ();

                        if (cl)
                          {
                            xyz::comment_elt elt = cl->front ();
...
class_property  : stash_comment identifier arg_validation
                  {
                    ...
                    xyz::tree_arg_validation *av = $3;

                    av->arg_name ($2);

                    if (av->size_spec () || av->class_name ()
                        || av->validation_fcns ())
                      warning (_("size, class, and validation function specifications are not yet supported for classdef properties; INCORRECT RESULTS ARE POSSIBLE!"));

                    $$ = new xyz::tree_classdef_property (av, $1);
                  }
                ;
...
methods_list1   : method
                  {
                    ...
                    if ($1)
                      fcn = $1->function ();
                    delete $1;
                    $$ = new xyz::tree_classdef_methods_list (fcn);
                  }
...
events_list1    : class_event
                  { $$ = new xyz::tree_classdef_events_list ($1); }
...
class_event     : stash_comment identifier
                  { $$ = new xyz::tree_classdef_event ($2, $1); }
                ;
...
enum_list1      : class_enum
                  { $$ = new xyz::tree_classdef_enum_list ($1); }
...
class_enum      : stash_comment identifier '(' expression ')'
                  {
                    ...
                    $$ = new xyz::tree_classdef_enum ($2, $4, $1);
                  }
                ;
...
static void
yyerror (xyz::base_parser& parser, const char *s)
{
...
namespace xyz
{
  ...
  base_parser::push_fcn_symtab (void)
  {
    ...
    if (m_lexer.m_reading_script_file && m_curr_fcn_depth > 0)
      {
        bison_error (_("nested functions not implemented in this context"));
      ...
      case SQ_STRING:
        {
          ...
          xyz_value tmp (txt, delim);

          if (txt.empty ())
            {
              if (op == DQ_STRING)
                tmp = xyz_null_str::instance;
              else
                tmp = xyz_null_sq_str::instance;
            }
        ...
        try
          {
            ...
            xyz_value tmp = expr->evaluate (tw);
  ...
  {
    xyz_value::binary_op t = xyz_value::unknown_binary_op;
    ...
    switch (op)
      ...
      case EMUL:
        t = xyz_value::op_el_mul;
        break;

      case EDIV:
        t = xyz_value::op_el_div;
        break;
      ...
      case EXPR_AND:
        t = xyz_value::op_el_and;
        break;

      case EXPR_OR:
        t = xyz_value::op_el_or;
        break;
  ...
  {
    xyz_value::unary_op t = xyz_value::unknown_unary_op;
    ...
    switch (op)
      ...
      case '+':
        t = xyz_value::op_uplus;
        break;

      case '-':
        t = xyz_value::op_uminus;
        break;
  ...
  base_parser::make_postfix_op (int op, tree_expression *op1, token *tok_val)
  {
    ...
    switch (op)
      {
      case HERMITIAN:
        t = xyz_value::op_hermitian;
        break;

      case TRANSPOSE:
        t = xyz_value::op_transpose;
        break;
            ...
            if (parfor)
              {
                ...
                bison_error (_("invalid syntax for parfor statement"));
              }
            else
  ...
  base_parser::make_break_command (token *break_tok)
  {
    ...
    if (! m_lexer.m_looping)
      {
        bison_error (_("break must appear within a loop"));
        return nullptr;
      }
    else
  ...
  base_parser::make_continue_command (token *continue_tok)
  {
    ...
    if (! m_lexer.m_looping)
      {
        bison_error (_("continue must appear within a loop"));
        return nullptr;
      }
    else
  ...
  {
    xyz_value::assign_op t = xyz_value::unknown_assign_op;

    switch (op)
      {
      case '=':
        t = xyz_value::op_asn_eq;
        break;

      case ADD_EQ:
        t = xyz_value::op_add_eq;
        break;

      case SUB_EQ:
        t = xyz_value::op_sub_eq;
        break;

      case MUL_EQ:
        t = xyz_value::op_mul_eq;
        break;

      case DIV_EQ:
        t = xyz_value::op_div_eq;
        break;

      case LEFTDIV_EQ:
        t = xyz_value::op_ldiv_eq;
        break;

      case POW_EQ:
        t = xyz_value::op_pow_eq;
        break;

      case EMUL_EQ:
        t = xyz_value::op_el_mul_eq;
        break;

      case EDIV_EQ:
        t = xyz_value::op_el_div_eq;
        break;

      case ELEFTDIV_EQ:
        t = xyz_value::op_el_ldiv_eq;
        break;

      case EPOW_EQ:
        t = xyz_value::op_el_pow_eq;
        break;

      case AND_EQ:
        t = xyz_value::op_el_and_eq;
        break;

      case OR_EQ:
        t = xyz_value::op_el_or_eq;
        break;
    ...
    if (! lhs->is_simple_assign_lhs () && t != xyz_value::op_asn_eq)
      {
        ...
        bison_error (_("computed multiple assignment not allowed"),
                     eq_tok->beg_pos ());
    ...
    if (lhs->is_simple_assign_lhs ())
      {
        ...
        if ((tmp->is_identifier () || tmp->is_index_expression ())
            && iskeyword (tmp->name ()))
          {
            ...
            bison_error (_("invalid assignment to keyword \"") + kw + "\"",
                         eq_tok->beg_pos ());
                            ...
                            tree_statement *end_script)
  {
    ...
    xyz_user_script *script
      = new xyz_user_script (m_lexer.m_fcn_file_full_name,
    ...
    m_primary_fcn = xyz_value (script);
  }
  ...
  base_parser::make_fcn_name (tree_identifier *id)
  {
    ...
    if (! m_function_scopes.name_current_scope (id_name))
      {
        bison_error (_("duplicate subfunction or nested function name"),
                     id->line (), id->column ());
                               ...
                               tree_statement *end_fcn_stmt)
  {
    ...
    xyz_user_function *fcn
      = new xyz_user_function (m_lexer.m_symtab_context.curr_scope (),
    ...
    if (! m_autoloading && m_lexer.m_reading_fcn_file
        && m_curr_fcn_depth == 0 && ! m_parsing_subfunctions)
      {
        ...
        if (nm != id_name)
          {
            warning_with_id
              ("XYZ:function-name-clash",
               _("function name '%s' does not agree with function filename '%s'"),
    ...
    if (m_lexer.m_reading_fcn_file || m_lexer.m_reading_classdef_file || m_autoloading)
      {
        ...
        if (fs && fs.is_newer (now))
          warning_with_id ("XYZ:future-time-stamp",
                           _("time stamp for '%s' is in the future"), nm.c_str ());
      }
    ...
    if (nm != cls_name)
      {
        ...
        bison_error (_("invalid classdef definition, the class name must match the filename"), l, c);
  ...
  {
    xyz_user_function* retval = nullptr;
    ...
    if (! m_curr_class_name.empty ())
      {
        ...
        if (mname.find_first_of (".") == std::string::npos
            ...
            && mname != m_curr_class_name)
          {
            ...
            retval = new xyz_user_function (symbol_scope (), pl);
          ...
          bison_error (_("invalid external method declaration, an external "
                       "method cannot be the class constructor, 'delete' "
                       "or have a dot (.) character in its name"));
      }
    else
      bison_error (_("external methods are only allowed in @-folders"));
  ...
  tree_function_def *
  base_parser::finish_classdef_external_method (xyz_user_function *fcn,
                                                tree_parameter_list *ret_list,
                                                comment_list *cl)
  {
    if (! ret_list)
        ...
        for (tree_statement *elt : *local_fcns)
          {
            ...
            xyz_value ov_fcn = fcn_def->function ();
            xyz_function *fcn = ov_fcn.function_value ();
    ...
    if (args && args->has_magic_tilde ())
      {
        ...
        bison_error (_("invalid use of empty argument (~) in index expression"));
      }
    else
      {
        int l = expr->line ();
        ...
        if (m_curr_fcn_depth >= 0)
        ...
        else
          {
            if (m_lexer.m_reading_script_file)
              warning (_("ignoring persistent declaration near line %d of file '%s'"),
                       l, m_lexer.m_fcn_file_full_name.c_str ());
            else
              warning (_("ignoring persistent declaration near line %d"), l);
          }
        break;
            ...
            if (id->is_black_hole ())
              {
                if (type != tree_parameter_list::in)
                  {
                    bison_error (_("invalid use of ~ in output list"));
                    return false;
                  }
              }
            else if (iskeyword (name))
              {
                ...
                fmt << _("invalid use of keyword '") << name << _("' in parameter list");
                const std::string format = fmt.str();

//                bison_error (_("invalid use of keyword '") + name
//                             + _("' in parameter list"));
                bison_error(_(format.c_str()));
                return false;
              }
            else if (dict.find (name) != dict.end ())
              {
                bison_error ("'" + name
                             + _("' appears more than once in parameter list"));
                return false;
              }
            else
              dict.insert (name);
        ...
        if (row && row->has_magic_tilde ())
          {
            ...
            if (e->is_matrix ())
              bison_error (_("invalid use of tilde (~) in matrix expression"));
            else
              bison_error (_("invalid use of tilde (~) in cell expression"));
    ...
    if (e->is_constant ())
      {
        ...
        xyz_value ov = e->evaluate (tw);

        delete e;

        if (ov.isempty ())
          bison_error (_("invalid empty left hand side of assignment"));
        else
          bison_error (_("invalid constant left hand side of assignment"));
      }
    else
      {
        ...
        if (tmp && tmp->is_valid_lvalue_list ())
        ...
        else
          {
            ...
            bison_error (_("invalid left hand side of assignment"));
          }
        ...
        try
          {
            ...
            xyz_value tmp = array_list->evaluate (tw);
                              ...
                              token *close_delim)
  {
    return (m
            ...
            : new tree_constant (xyz_null_matrix::instance,
                            ...
                            token *close_delim)
  {
    return (c
            ...
            : new tree_constant (xyz_value (Cell ()),
                                 close_delim->line (), close_delim->column ()));
  }
                                    ...
                                    char sep, bool warn_missing_semi)
  {
    ...
    switch (sep)
      ...
      default:
        warning (_("unrecognized separator type!"));
        break;
      }
  ...
  base_parser::bison_error (const std::string& str, int err_line, int err_col)
  {
    ...
    if (m_lexer.m_reading_fcn_file || m_lexer.m_reading_script_file
      ...
      output_buf << _("error in ") << m_lexer.m_fcn_file_full_name << " (" << err_line << ")";
//                 << " of file " << m_lexer.m_fcn_file_full_name;
    else
      output_buf << _("parse antlr grammar error");
  ...
  parser::run (void)
  {
    ...
    try
      {
        status = xyz_pull_parse (pstate, *this);
      }
    catch (const execution_exception&)
      {
    ...
    catch (...)
      {
        ...
        if (file.empty ())
          error (_("unexpected exception while parsing input"));
        else
          error (_("unexpected exception while parsing %s"), file.c_str ());
      }
    ...
    do
      {
        ...
        int token = xyz_lex (&lval, m_lexer.m_scanner);
        ...
        try
          {
            status = xyz_push_parse (pstate, token, &lval, *this);
          }
        catch (execution_exception& e)
          {
            ...
            if (file.empty ())
              error (e, _("error in empty file"));
            else
              error (e, _("error in %s"), file.c_str ());
          }
        catch (const exit_exception&)
          {
            throw;
        ...
        catch (...)
          {
            ...
            if (file.empty ())
              error (_("unknown error when parsing input"));
            else
              error (_("unknown error when parsing %s"), file.c_str ());
          }
      }
  ...
  {
    if (! m_reader)
      error (_("push_parser::run requires valid input_reader"));
                  ...
                  bool force_script, bool autoload, bool relative_lookup)
  {
    ...
    if (! full_file.empty ())
    {
      ...
      if (fs && fs.size () > max_file_size)
        {
          error (_("file '%s' is too large, > 512 MB"), full_file.c_str ());
    ...
    if (! ffile)
      {
        if (require_file)
          error (_("no such file, '%s'"), full_file.c_str ());
    ...
    xyz::input_system& input_sys = interp.get_input_system ();
    ...
    if (err)
      error (_("parse error while reading file %s"), full_file.c_str ());

    xyz_value ov_fcn = parser.m_primary_fcn;
    ...
    if (expr->is_assignment_expression ()
        && expr->paren_count () < 2)
      {
        if (m_lexer.m_fcn_file_full_name.empty ())
          warning_with_id
            ("XYZ:assign-as-truth-value",
             _("suggest parenthesis around assignment used as truth value"));
        else
          warning_with_id
            ("XYZ:assign-as-truth-value",
             _("suggest parenthesis around assignment used as truth value near line %d, column %d in file '%s'"),
  ...
  base_parser::maybe_warn_variable_switch_label (tree_expression *expr)
  {
    if (! expr->is_constant ())
      {
        if (m_lexer.m_fcn_file_full_name.empty ())
          warning_with_id ("XYZ:variable-switch-label",
                           _("variable switch label"));
        else
          warning_with_id
            ("XYZ:variable-switch-label",
             _("variable switch label near line %d, column %d in file '%s'"),
             expr->line (), expr->column (), m_lexer.m_fcn_file_full_name.c_str ());
      }
  }
    ...
    if (m_curr_fcn_depth >= 0)
      {
        ...
        if (tmp->is_expression ())
          warning_with_id
            ("XYZ:missing-semicolon",
             _("missing semicolon near line %d, column %d in file '%s'"),
                      ...
                      std::string& full_file)
  {
    ...
    if ((file_len > 4 && file.substr (file_len-4) == ".xot")
                      ...
                      const std::string& fcn_name, bool autoload)
  {
    ...
    if ((nm_len > 4 && nm.substr (nm_len-4) == ".xot")
    ...
    if (len > 4 && file.substr (len-4, len-1) == ".xot")
      {
    ...
    else if (len > 4 && file.substr (len-4, len-1) == ".mex")
      {
        ...
        if (ov_fcn.is_defined ())
          {
            xyz_function *tmpfcn = ov_fcn.function_value ();
...
command was run.  @var{file} @emph{should not} depend on the Xyz load
path.

Normally, calls to @code{autoload} appear in PKG_ADD script files that are
evaluated when a directory is added to Xyz's load path.  To avoid having
to hardcode directory names in @var{file}, if @var{file} is in the same
directory as the PKG_ADD script then

@example
autoload ("foo", "bar.xot");
@end example

@noindent
will load the function @code{foo} from the file @code{bar.xot}.  The above
usage when @code{bar.xot} is not in the same directory, or usages such as

@example
autoload ("foo", file_in_loadpath ("bar.xot"))
@end example
...
not loaded anymore during the current Xyz session.
...
@end deftypefn */)
{
  ...
  xyz::tree_evaluator& tw = interp.get_evaluator ();

  if (nargin == 0)
    return xyz_value (tw.get_autoload_map ());
  else
    {
      ...
      if (nargin == 2)
        ...
        {
          if (argv[3] != "remove")
            error_with_id ("XYZ:invalid-input-arg",
                           _("autoload: third argument can only be 'remove'"));
...
@end deftypefn */)
{
  ...
  if (nargin == 1)
    opt = args(0).xstring_value (_("mfilename: option argument must be a string"));

  return xyz_value (interp.mfilename (opt));
}
...
@end deftypefn */)
{
  ...
  std::string file_name
    = args(0).xstring_value (_("source: FILE must be a string"));

  std::string context;
  if (nargin == 2)
    context = args(1).xstring_value (_("source: CONTEXT must be a string"));
...
namespace xyz
{
  //! Evaluate an Xyz function (built-in or interpreted) and return
  ...
  xyz_value_list
  feval (const char *name, const xyz_value_list& args, int nargout)
  {
  ...
  xyz_value_list
  feval (const std::string& name, const xyz_value_list& args, int nargout)
  {
    interpreter& interp = __get_interpreter__ ("feval");
  ...
  xyz_value_list
  feval (xyz_function *fcn, const xyz_value_list& args, int nargout)
  {
    interpreter& interp = __get_interpreter__ ("feval");
  ...
  xyz_value_list
  feval (const xyz_value& val, const xyz_value_list& args, int nargout)
  {
    interpreter& interp = __get_interpreter__ ("feval");
  ...
  xyz_value_list
  feval (const xyz_value_list& args, int nargout)
  {
    interpreter& interp = __get_interpreter__ ("feval");
...
a requirement to call one of Xyz's base functions rather than the
...
@end deftypefn */)
{
  xyz_value_list retval;

  if (args.length () == 0)
    print_usage ();

  const std::string name (args(0).xstring_value (_("builtin: function name (F) must be a string")));

  xyz::symbol_table& symtab = interp.get_symbol_table ();

  xyz_value fcn = symtab.builtin_find (name);

  if (fcn.is_defined ())
    retval = interp.feval (fcn.function_value (), args.splice (0, 1), nargout);
  else
    error (_("builtin: lookup for symbol '%s' failed"), name.c_str ());
...
Parse the string @var{try} and evaluate it as if it were an Xyz
program.
...
@end deftypefn */)
{
  ...
  if (! args(0).is_string () || args(0).rows () > 1 || args(0).ndims () != 2)
    error (_("eval: TRY must be a string"));
  ...
  if (nargin == 1)
  ...
  else
    {
      if (! args(1).is_string () || args(1).rows () > 1
          || args(1).ndims () != 2)
        error (_("eval: CATCH must be a string"));
...
@end deftypefn */)
{
  ...
  std::string context
    = args(0).xstring_value (_("assignin: CONTEXT must be a string"));

  std::string varname
    = args(1).xstring_value (_("assignin: VARNAME must be a string"));
...
@end deftypefn */)
{
  ...
  std::string context
    = args(0).xstring_value (_("evalin: CONTEXT must be a string"));

  std::string try_code
    = args(1).xstring_value (_("evalin: TRY must be a string"));

  if (nargin == 3)
    {
      std::string catch_code
        = args(2).xstring_value (_("evalin: CATCH must be a string"));
...
Parse and evaluate the string @var{try} as if it were an Xyz program,
...
@end deftypefn */)
{
  ...
  std::streambuf *old_out_buf = xyz_stdout.rdbuf (&buffer);
  ...
  xyz::unwind_action act ([=] (void)
                             {
                               xyz_stdout.rdbuf (old_out_buf);
  ...
  xyz_value_list retval = Feval (interp, args, eval_nargout);
...
Query or set the internal flag that determines whether Xyz's parser
...
@end deftypefn */)
{
  ...
  std::string file
    = args(0).xstring_value (_("__parse_file__: expecting filename as argument"));

  std::string full_file = xyz::sys::file_ops::tilde_expand (file);

  full_file = xyz::sys::env::make_absolute (full_file);
  ...
  if ((file_len > 4 && file.substr (file_len-4) == ".xot")
      ...
      || (file_len > 2 && file.substr (file_len-2) == ".m"))
    {
      file = xyz::sys::env::base_pathname (file);
      file = file.substr (0, file.find_last_of ('.'));

      std::size_t pos = file.find_last_of (xyz::sys::file_ops::dir_sep_str ());
      if (pos != std::string::npos)
        {
  ...
  if (nargin == 2)
    xyz_stdout << "parsing " << full_file << std::endl;
